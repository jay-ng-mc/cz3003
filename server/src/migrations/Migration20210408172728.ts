...
export class Migration20210408172728 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "game" ("id" serial primary key, "username" text not null, "start_time" timestamptz(0) not null, "end_time" timestamptz(0) not null, "score" int4 not null);');
